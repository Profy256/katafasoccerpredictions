...
import { getAnalystRecord, getPackages } from '@/api/client';
import { HitRateBars } from '@/components/charts/HitRateBars';
import { SlipCard } from '@/components/SlipCard';
import { getOwnedSlipIds } from '@/lib/session';
import {
  formatCount,
  formatDate,
  formatOdds,
...
export async function generateMetadata({
  ...
  return {
    title: `${record.analyst.name} — record`,
    description: `Public auto-graded tipping record for ${record.analyst.name} on Katafa.`,
  };
}

...
export const metadata: Metadata = {
  title: 'Pro Football Betting Tips & Slips',
  description:
    'Hand-built football betting slips from Ugandan analysts, sold individually across three packages in UGX via mobile money. Every analyst’s public, auto-graded track record is checkable before you buy — including their losses.',

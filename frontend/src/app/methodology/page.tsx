...
export const metadata: Metadata = {
  title: 'How Our Football Predictions Are Made',
  description:
    'How Katafa generates statistical football predictions: a Poisson goal-expectation model (not AI, not machine learning), what the confidence number means, and what the model cannot see.',
    ...
    <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6">
      ...
      <section className="mt-10">
        ...
        <p className="mt-3 text-[15px] leading-relaxed text-fg-muted">
          ...
          for what &ldquo;confidence&rdquo; does and doesn&rsquo;t promise.
        </p>
      </section>

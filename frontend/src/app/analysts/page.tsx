...
export const metadata: Metadata = {
  title: 'Football Tipster Leaderboard',
  description:
    'The public, auto-graded track record for every analyst publishing paid football betting tips on Katafa — hit rate, sample size and ROI, ranked and open to check before you buy.',
